    ...
    dio.interceptors.add(InterceptorsWrapper(
        onRequest:(RequestOptions options){
          print("Dio Intercepter: onResponse "
              "\nurl: ${url.toString()}"
              "\nResponse Type: ${options.baseUrl.toString()}"
              "\nHeaders: ${options.contentType.toString()}"
...
class MethodBuilder {
  ...
  MethodBuilder addJSONObjectBody(Map<String, dynamic> data) {
    this.formData.addAll(data);
    return this;
  }
